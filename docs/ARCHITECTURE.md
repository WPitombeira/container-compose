...
- Accept `pause` service targeting and emit service-scoped diagnostic planned actions. The execution runner treats those actions as unsupported before invoking Apple Container until a real pause primitive is verified.
